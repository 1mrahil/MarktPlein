   ...
   if(isset($_POST['verzenden'])){
       ...
       if(mysqli_query($conn, $query)) {
           header('Location: '.ROOT_URL.'');
            ...
            echo 'alert(Advertentie geplaatst!)';
            echo '</script>';
       } else {
    ...
    <div class="flex-container">
        <main class="box">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
                ...
                <h3>Naam product</h3>
                <input type="text" name="naam" placeholder="Naam product" value="">
               <h4>Omschrijving</h4>
                <textarea name="omschrijving" type="text" placeholder="Omschrijving" rows="5" cols="25" value="<?php echo $omschrijving;?>"></textarea><br>
                <input id="button" type="submit" value="Upload foto's"><br>
                <input name="verzenden" id="button" type="submit" value="Verzenden">
